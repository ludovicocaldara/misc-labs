...
3. Provisions **two DB Systems** (`members = 2` by default) with Oracle Database 26ai, single-node shapes, and your supplied SSH key so you can log in via the bastion.
