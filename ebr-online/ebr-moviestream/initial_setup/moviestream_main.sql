...
REM =======================================================
REM create moviestream schema objects
REM =======================================================
...
ALTER TABLE MOVIE_RECOMMENDATIONSGT$ RENAME TO MOVIE_RECOMMENDATIONSGT$$0;
ALTER TABLE MOVIE_RECOMMENDATIONSIT$ RENAME TO MOVIE_RECOMMENDATIONSIT$$0;
ALTER TABLE MOVIE_RECOMMENDATIONSSS$ RENAME TO MOVIE_RECOMMENDATIONSSS$$0;
...
ALTER TABLE EXT_POTENTIAL_CHURNERS RENAME TO EXT_POTENTIAL_CHURNERS$0;
ALTER TABLE TIME RENAME TO TIME$0;
ALTER TABLE JSON_MOVIE_DATA_EXT RENAME TO JSON_MOVIE_DATA_EXT$0;
...
ALTER TABLE MOVIE_RECOMMENDATIONSVT$ RENAME TO MOVIE_RECOMMENDATIONSVT$$0;
ALTER TABLE MOVIE_RECOMMENDATIONSGE$ RENAME TO MOVIE_RECOMMENDATIONSGE$$0;

CREATE EDITIONING VIEW MOVIE_RECOMMENDATIONSGT$ AS
   SELECT
      EID
    , EL
    , SVID
    ...
    , ELS
     FROM
      MOVIE_RECOMMENDATIONSGT$$0;

CREATE EDITIONING VIEW MOVIE_RECOMMENDATIONSIT$ AS
   SELECT
      EIN
    , ET
    , IT
    ...
    , OPTS
     FROM
      MOVIE_RECOMMENDATIONSIT$$0;

CREATE EDITIONING VIEW MOVIE_RECOMMENDATIONSSS$ AS
   SELECT
      SSID
    , CONTENTS
    , SS_FILE
...
CREATE EDITIONING VIEW EXT_POTENTIAL_CHURNERS AS
   SELECT
      CUST_ID
    , WILL_CHURN
    , PROB_CHURN
     FROM
      EXT_POTENTIAL_CHURNERS$0;
...
CREATE EDITIONING VIEW JSON_MOVIE_DATA_EXT AS
   SELECT
      DOC
     FROM
      JSON_MOVIE_DATA_EXT$0;

CREATE EDITIONING VIEW CUSTOMER AS
   SELECT
      CUST_ID
    , LAST_NAME
    , FIRST_NAME
...
CREATE EDITIONING VIEW MOVIE_RECOMMENDATIONSVT$ AS
   SELECT
      VID
    , VL
    , K
    ...
    , FE
     FROM
      MOVIE_RECOMMENDATIONSVT$$0;

CREATE EDITIONING VIEW MOVIE_RECOMMENDATIONSGE$ AS
   SELECT
      EID
    , SVID
    , DVID
