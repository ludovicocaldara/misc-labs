...
for row in df.itertuples():
  try:
    ...
    print("App version: %s - Edition: %s - Country Code %s - Country %s - Continent %s - Inserting customer: %s %s" % (app_version, db_edition, row.COUNTRY_CODE, row.COUNTRY, row.CONTINENT, row.FIRST_NAME, row.LAST_NAME))
    time.sleep(2)
