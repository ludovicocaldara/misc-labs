...
begin
        ...
        then
           select nvl(substr(country,1,instr(country,',')-1),country), continents$0.continent into :new.country, :new.continent
		     from countries$0, continents$0 where countries$0.continent_code = continents$0.continent_code
