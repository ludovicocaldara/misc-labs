...
DROP TABLE regions$0     CASCADE CONSTRAINTS;
DROP TABLE departments$0 CASCADE CONSTRAINTS;
DROP TABLE locations$0   CASCADE CONSTRAINTS;
DROP TABLE jobs$0        CASCADE CONSTRAINTS;
DROP TABLE job_history$0 CASCADE CONSTRAINTS;
DROP TABLE employees$0   CASCADE CONSTRAINTS;
DROP TABLE countries$0   CASCADE CONSTRAINTS;  
